...
public class Recorder {
     ...
     * @param latencyUnit
     */
    public Recorder(long minLatency, long maxLatency, long goalLatency,
        ...
        this.latency = new org.HdrHistogram.Recorder(
                latencyUnit.toMicros(minLatency),
    ...
    public void record(long startNanoTime) {
        final long duration = TimeUnit.NANOSECONDS
                .toMicros(System.nanoTime() - startNanoTime);
        count.add(1);
    ...
    public Snapshot interval() {
        ...
        final long tolerating = h.getCountBetweenValues(goalLatency,
                goalLatency * 4);
